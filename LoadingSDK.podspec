#
#  Be sure to run `pod spec lint LoadingSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "ZhangWei"
  # s.authors            = { "ZhangWei" => "zhangwei36@kongjianjia.com" }
  # s.social_media_url   = "http://twitter.com/ZhangWei"
